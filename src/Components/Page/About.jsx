...
export default function About() {
  return (
    <>
      ...
      {/* travel experience */}
      <section className='travel-experince my-5'>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className="section-title travel-experince-title">
                <div className="d-flex align-items-center gap-3 mb-3">
                  <img src={star} alt="star-image" className='img-fluid' />
                  <h3 className='m-0'>Get To Knew Us</h3>
                </div>
                ...
                <ul className='list-unstyled pt-4'>
                  <li className='d-flex align-items-center gap-3 pb-4'>
                    ...
                    <div>
                      <h4>Best of Hotel</h4>
                      <p className='w-100'>
                        We don't just work with concerete and steel. <br />
                        We are Approachable, with even our highdst
                      </p>
                    </div>
            ...
            <div className="col-lg-5 mb-4 mb-lg-0">
              <div className="section-title travel-places-title">
                ...
                <div className="travel-experience-btn mt-4">
                  ...
                  <p style={{ fontWeight: '700', fontSize: '1.3rem' }}>500+ Happy Customer</p>
                </div>
                ...
                <div className="col-lg-6">
                  <div className="travel-places-info">
                    ...
                    <ul className='list-unstyled pt-3 travel-place-ul'>
                      <li className='pb-3'> <i className='fa-solid fa-check me-2'></i> Generation Technologey</li>
                      <li className='pb-3'> <i className='fa-solid fa-check me-2'></i>Generation Technologey </li>
                      <li className='pb-3'> <i className='fa-solid fa-check me-2'></i>Generation Technologey </li>
                    </ul>
                  </div>
            ...
            <div className="col-12">
              <div className="row g-4 justify-content-center">
                <div className="col-lg-4 ">
                  <div className="card h-100 shadow-lg rounded-4 p-5 text-start border-0 price-card">
                    <h2><sub>$</sub>99<small>/month</small></h2>
                    <div className="d-flex justify-content-center my-4 w-100">
                      <img src={price1} alt="tour1" className='rounded-2 object-fit-cover' width='70%' style={{border:"100px"}} />
                      <img src={price2} alt="tour1" className='rounded-circle ms-2 object-fit-cover' width='30%' />
                    </div>
                    <h4 className='fw-bold fs-1'>Turkey Tour</h4>
                    <p className='text-muted fs-5'>
                                         We don't just work with concret we are Approchable,
                ...
                <div className="col-lg-4">
                  <div className="card h-100 shadow-lg rounded-4 p-5 text-start border-0 price-card">
                    <h2><sub>$</sub>79<small>/month</small></h2>
                    <div className="d-flex justify-content-center my-4 w-100">
                      <img src={price3} alt="tour1" className='rounded-2 object-fit-cover' width='70%' style={{border:"100px"}} />
                      <img src={price4} alt="tour1" className='rounded-circle ms-2 object-fit-cover' width='30%' />
                    </div>
                ...
                <div className="col-lg-4">
                  <div className="card h-100 shadow-lg rounded-4 p-5 text-start border-0 price-card">
                    <h2><sub>$</sub>49<small>/month</small></h2>
                    <div className="d-flex justify-content-center my-4 w-100">
                      <img src={price5} alt="tour1" className='rounded-2 object-fit-cover' width='70%' style={{border:"100px"}} />
                      <img src={price6} alt="tour1" className='rounded-circle ms-2 object-fit-cover' width='30%' />
                    </div>
                    <h4 className='fw-bold fs-1'>World Travel</h4>
                    <p className='text-muted fs-5'>
                     We don't just work with concret we are Approchable,
                    </p>
                    <hr />
